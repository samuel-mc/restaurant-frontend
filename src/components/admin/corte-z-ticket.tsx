...
export function CorteZTicket({ record, onClose }: CorteZTicketProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
      <div className="flex max-h-[90vh] flex-col rounded-2xl bg-card p-4 shadow-2xl print:bg-white print:p-0 print:shadow-none">
        ...
        <div className="overflow-y-auto pt-3 print:overflow-visible print:pt-0">
          <div
            id="corte-z-printable"
            className="thermal-receipt-container mx-auto w-[302px] border border-black bg-white p-3 font-mono text-xs text-black print:w-[302px] print:border-none print:m-0 print:p-0 print:bg-white print:text-black"
            ...
            <div className="py-2 text-[11px]">
              ...
              <div className="mt-1 space-y-1">
                <div className="flex justify-between">
                  ...
                  <strong className="tabular-nums">{formatCurrency(record.totalSales)}</strong>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="tabular-nums">{formatCurrency(record.averageTicket)}</span>
                </div>
                <div className="flex justify-between">
