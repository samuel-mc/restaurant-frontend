...
/** Nombre de la cookie que guarda el JWT del panel admin (por tenant). */
export const ADMIN_TOKEN_COOKIE = "pl_admin_token";

/** Cookie del backoffice global (SUPER_ADMIN), independiente del admin de tenant. */
export const SUPERADMIN_TOKEN_COOKIE = "pl_superadmin_token";
